    ...
    <>
      ...
      <div>
        <div className="max-w-sm w-full lg:max-w-full lg:flex p-4">
          ...
          ></div>
          <div className="border-r border-b border-l border-yellow-400 lg:border-l-0 lg:border-t lg:border-yellow-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
            <div className="mb-8">
        ...
        <div className="max-w-sm w-full lg:max-w-full lg:flex p-4">
          ...
          <div className="border-r border-b border-l border-yellow-400 lg:border-l-0 lg:border-t lg:border-yellow-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
            <div className="mb-8">
              ...
              <p className="text-gray-700 text-base">
                Please fill out the form for either July 10th or July 17th.
              </p>
            </div>
            <div className="flex items-center">
              <img
